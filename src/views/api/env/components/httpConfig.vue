  ...
  <div class="content">
    ...
    <div class="block-title">
      ...
      <el-popover placement="top" :width="400" trigger="click">
        <template #reference>
          <el-button type="primary" link @click="bulkEdit">批量添加</el-button>
        </template>
        <el-input type="textarea" show-word-limit v-model="headersBulk"></el-input>
        <el-button type="primary" link @click="bulkToKeyValue">添加</el-button>
      </el-popover>

    </div>

    <headers-controller :data="data.headers"></headers-controller>
