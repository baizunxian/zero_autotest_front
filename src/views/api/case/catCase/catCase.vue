  ...
  <div class="system-edit-menu-container">
    <el-card class="save-update-card" shadow="hover">
      <div>
        ...
        <messages ref="messagesRef" @onCatTestCase="onCatTestCase"/>
...
import Messages from '/@/views/api/case/catCase/catMessages.vue'
...
export default defineComponent({
  ...
  setup(props, {emit}) {
    ...
    const initTestCast = () => {
      if (props.case_id) {
        useTestCaseApi().getTestCaseInfo({id: props.case_id})
            .then(res => {
              let data = res.data
    ...
    const onCatTestCase = (case_id: number | string) => {
      console.log('-------------------------cat case')
      emit('onCatTestCase', case_id)
    }
