...
export default defineComponent({
  name: 'apiTestCase',
  components: {saveOrUpdate, TestReport},
  setup() {
      ...
      importFormRef.value.validate(async (vai: any) => {
        if (vai) {
          ...
          try {
            ...
            let res: any = await useApiCaseApi().postman2case(formData)
